...
|       |Windows<br/>[![](https://img.shields.io/github/actions/workflow/status/winfsp/cgofuse/test.yml?branch=master)](https://github.com/winfsp/cgofuse/actions/workflows/test.yml)|macOS<br/>[![](https://img.shields.io/github/actions/workflow/status/winfsp/cgofuse/test.yml?branch=master)](https://github.com/winfsp/cgofuse/actions/workflows/test.yml)|Linux<br/>[![](https://img.shields.io/github/actions/workflow/status/winfsp/cgofuse/test.yml?branch=master)](https://github.com/winfsp/cgofuse/actions/workflows/test.yml)|FreeBSD<br/>[![no CI](https://img.shields.io/badge/build-none-lightgrey.svg)](https://cirrus-ci.com/github/billziss-gh/cgofuse)|NetBSD<sup>*</sup><br/>![no CI](https://img.shields.io/badge/build-none-lightgrey.svg)|OpenBSD<sup>*</sup><br/>![no CI](https://img.shields.io/badge/build-none-lightgrey.svg)|
|:-----:|:------:|:------:|:------:|:------:|:------:|:------:|
|  cgo  |&#x2713;|&#x2713;|&#x2713;|&#x2713;|&#x2713;|&#x2713;|
| !cgo  |&#x2713;|        |        |        |        |        |
